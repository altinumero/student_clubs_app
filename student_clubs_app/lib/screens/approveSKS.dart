...
class ApproveSKS extends StatefulWidget {
  const ApproveSKS({Key key}) : super(key: key);

  @override
  State<ApproveSKS> createState() => _ApproveSKSState();
}

class _ApproveSKSState extends State<ApproveSKS> {
  var advisorsclub;
  @override
          ...
          body: ListView(physics: const BouncingScrollPhysics(), children: [
            StreamBuilder(
                stream: Firestore.instance
                    .collection('events')
                    .where("approvedByAdvisor", isEqualTo: "true")
                    .where("approvedBySKS", isEqualTo: "false")
                    .snapshots(),
                            ...
                            child: ListTile(
                              ...
                              trailing: ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  Firestore.instance
                                      .collection("events")
                                      .document(documents[index]["EventName"])
